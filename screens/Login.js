      ...
      <View style={{flex:4}}>
        ...
        <View style={{alignItems:"center",marginTop:150}}>
          <Text style={{fontWeight:"500", fontSize:16, color:"#A5A5A5"}}>Don't have an account?
            <Text onPress={() => props.navigation.navigate('SignupOne')} style={{color:"#FAA41E"}} > Sign Up</Text>
          </Text>
        </View>
